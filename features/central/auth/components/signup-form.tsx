...
import {
  ...
  signupSchema,
} from "@/features/central/auth/schemas"
          ...
          {steps.map((item, index) => (
            ...
            >
              ...
              {index < steps.length - 1 && (
                <StepperSeparator className="absolute inset-x-0 top-4 start-[calc(50%+1.25rem)] m-0 group-data-[orientation=horizontal]/stepper:w-[calc(100%-2.5rem)] group-data-[orientation=horizontal]/stepper:flex-none" />
              )}
            </StepperItem>
          ))}
        </StepperNav>
