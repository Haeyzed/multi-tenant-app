...
import { columns } from "@/features/central/billing/features/components/features-columns"
...
export function FeaturesTable() {
  ...
  const { data, isLoading, error } = useGetFeatures({
  ...
  useQueryErrorToast(error ?? null, "Failed to load features.")
