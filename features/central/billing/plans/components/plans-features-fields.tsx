...
const limitTypeOptions: {label: string; value: FeatureLimitType}[] = [
                ...
                <Controller
                    ...
                    render={({field}) => (
                        <div className="flex flex-col gap-2">
                            {catalog.map((feature) => {
                                const current = assignmentForFeature(
                                    field.value,
                                    feature.id
                                )
