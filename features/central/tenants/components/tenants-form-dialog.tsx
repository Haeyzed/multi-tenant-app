...
import {useCreateTenant, useUpdateTenant,} from "@/features/central/tenants/hooks/use-tenant-query"
import {
...
const createStatusOptions: StatusOption[] = [
...
export function TenantsFormDialog({
    ...
    const selectedStatus =
        createStatusOptions.find((option) => option.value === statusValue) ?? null
