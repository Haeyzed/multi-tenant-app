...
import {Building2Icon, CheckCircle2Icon, FlaskConicalIcon, LockIcon, PauseCircleIcon,} from "lucide-react"
        ...
        <PermissionGate
            ...
            fallback={
                <div
                    ...
                    <span className="text-muted-foreground text-xs">You lack permission to view tenant metrics.</span>
                </div>
            }
        >
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
