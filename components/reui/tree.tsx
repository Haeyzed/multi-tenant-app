...
function TreeDragLine({
  ...
  return (
    <div
      style={dragLine}
      className={cn(
        "bg-primary before:bg-background before:border-primary absolute z-30 -mt-px h-0.5 w-[unset] before:absolute before:-top-[3px] before:start-0 before:size-2 before:border-2",
        "before:rounded-full",
        className
      )}
      {...props}
